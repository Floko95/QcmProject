...
('quest','Informatique','C',true,true),
('quest','Informatique','HTML',true,true),
('quest','Mathématiques','Algèbre',true,true),
('quest','Mathématiques','Géometrie',true,true),
('Bernard','Culture Générale','Histoire',true,true),
('Bernard','Culture Générale','Cinéma',true,true);
